...
describe('Signin actions', () => {
  ...
  it('creates a success flash message when user logs out ', () => {
    ...
    const expectedActions = [{ type: 'UNSET_USER' }, { type: 'ACTION_SUCCESS', payload: { status: false, actionName: 'SIGNOUT_SUCCESSFUL' } }, { type: 'ADD_FLASH_MESSAGE', message: { type: 'success', text: 'signout successful' } }];
